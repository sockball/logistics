...
function _0x3966d3(_0x8517d0, _0xae9512, _0x1e1c09) {
    // 均来自 track.min.js
    // _0x126b58 = _0xae9512[_0x1e1c09]['className'] 实际为 <li id="jcHeaderInput" class="...">...</li>元素的class
    // 当前有效值 "margin-horizontal-10.yq-input-container"
    var _0x126b58 = className;
    // 150 即 window[_0x4f3f('0x5c', 'MtlY')] 实际为window.innerHeight 不影响最终结果
    _0x126b58 = _0x126b58 + '/' + Date['now']()[_0x4f3f('0x5b', 'VMDb')](0x10) + '/' +
        150[_0x4f3f('0x5b', 'VMDb')](0x10) + '/' + _0x4ba351();
